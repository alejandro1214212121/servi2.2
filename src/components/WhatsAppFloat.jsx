...
const WA_URL = `https://wa.me/573115166081?text=${encodeURIComponent(
  "Hola, quisiera hacer un pedido o solicitar información."
)}`;
...
function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-[#6BBF59] hover:bg-[#4A9A39] text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl"
